...
<div class="companies-contacts-view">
    ...
    <?php $this->beginBlock('app\models\CompaniesContacts'); ?>
...
[
    ...
    <?= Tabs::widget(
                 [
                     ...
                     'encodeLabels' => false,
                     'items' => [ [
    'label'   => '<span class="glyphicon glyphicon-asterisk"></span> CompaniesContacts',
    'content' => $this->blocks['app\models\CompaniesContacts'],
    'active'  => true,
], ]
                 ]
    );
