...
* @var app\models\AirportHotelsSearch $searchModel
*/

    $this->title = 'Airport Hotels';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="airport-hotels-index">
    ...
    [
        'label' => '<i class="glyphicon glyphicon-arrow-left"> Hotels</i>',
        'url' => [
            'hotels/index',
        ],
    ],
