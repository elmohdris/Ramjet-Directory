...
* @var app\models\AirportCateringCompaniesSearch $searchModel
*/

    $this->title = 'Airport Catering Companies';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="airport-catering-companies-index">
    ...
    [
        'label' => '<i class="glyphicon glyphicon-arrow-left"> Catering Companies</i>',
        'url' => [
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                Airport Catering Companies            </div>
