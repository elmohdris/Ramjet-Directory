...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="airport-catering-companies-form">

            <?php $form = ActiveForm::begin([
            'id' => 'AirportCateringCompanies',
            'layout' => 'horizontal',
...
$form->field($model, 'airport_id')->dropDownList(
    ...
    ['prompt' => 'Select']
			...
			<?= // generated by schmunk42\giiant\crud\providers\RelationProvider::activeField
$form->field($model, 'catering_companies_id')->dropDownList(
    \yii\helpers\ArrayHelper::map(app\models\CateringCompanies::find()->all(),'id','Name'),
    ['prompt' => 'Select']
); ?>
                </p>
                <?php $this->endBlock(); ?>
    ...
    Tabs::widget(
                 [
                   'encodeLabels' => false,
                     'items' => [ [
    'label'   => 'AirportCateringCompanies',
