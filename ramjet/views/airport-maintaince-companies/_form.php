...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="airport-maintaince-companies-form">

            <?php $form = ActiveForm::begin([
            'id' => 'AirportMaintainceCompanies',
            'layout' => 'horizontal',
...
$form->field($model, 'airport_id')->dropDownList(
    ...
    ['prompt' => 'Select']
			...
			<?= // generated by schmunk42\giiant\crud\providers\RelationProvider::activeField
$form->field($model, 'maintaince_companies_id')->dropDownList(
    \yii\helpers\ArrayHelper::map(app\models\MaintainanceCompanies::find()->all(),'id','Name'),
    ['prompt' => 'Select']
); ?>
                </p>
                <?php $this->endBlock(); ?>
    ...
    Tabs::widget(
                 [
                   'encodeLabels' => false,
                     'items' => [ [
    'label'   => 'AirportMaintainceCompanies',
