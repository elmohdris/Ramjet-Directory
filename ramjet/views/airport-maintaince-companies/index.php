...
* @var app\models\AirportMaintainceCompaniesSearch $searchModel
*/

    $this->title = 'Airport Maintaince Companies';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="airport-maintaince-companies-index">
    ...
    [
        'label' => '<i class="glyphicon glyphicon-arrow-left"> Maintainance Companies</i>',
        'url' => [
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                Airport Maintaince Companies            </div>
