...
<div class="slots-view">
    ...
    <?php $this->beginBlock('app\models\Slots'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            '<span class="glyphicon glyphicon-link"></span> ' . 'Attach' . ' Airport', ['airport-slot/create', 'AirportSlot'=>['slot_id'=>$model->id]],
...
<?php $this->endBlock() ?>
    ...
    <?= Tabs::widget(
                 [
                     ...
                     'encodeLabels' => false,
                     'items' => [ [
    'label'   => '<span class="glyphicon glyphicon-asterisk"></span> Slots',
    'content' => $this->blocks['app\models\Slots'],
    'active'  => true,
],[
