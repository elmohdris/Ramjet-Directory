...
<div class="fuel-companies-view">
    ...
    <?php $this->beginBlock('app\models\FuelCompanies'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            '<span class="glyphicon glyphicon-link"></span> ' . 'Attach' . ' Airport', ['airport-fuel-companies/create', 'AirportFuelCompany'=>['fuel_companies_id'=>$model->id]],
...
<?php $this->endBlock() ?>
    ...
    <?= Tabs::widget(
                 [
                     ...
                     'encodeLabels' => false,
                     'items' => [ [
    'label'   => '<span class="glyphicon glyphicon-asterisk"></span> FuelCompanies',
    'content' => $this->blocks['app\models\FuelCompanies'],
    'active'  => true,
],[
