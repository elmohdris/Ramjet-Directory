...
* @var app\models\MaintainanceCompaniesSearch $searchModel
*/

    $this->title = 'Maintainance Companies';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="maintainance-companies-index">
