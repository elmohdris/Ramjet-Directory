...
<div class="catering-companies-view">
    ...
    <?php $this->beginBlock('app\models\CateringCompanies'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            '<span class="glyphicon glyphicon-link"></span> ' . 'Attach' . ' Airport', ['airport-catering-companies/create', 'AirportCateringCompany'=>['catering_companies_id'=>$model->id]],
...
<?php $this->endBlock() ?>
    ...
    <?= Tabs::widget(
                 [
                     ...
                     'encodeLabels' => false,
                     'items' => [ [
    'label'   => '<span class="glyphicon glyphicon-asterisk"></span> CateringCompanies',
    'content' => $this->blocks['app\models\CateringCompanies'],
    'active'  => true,
],[
