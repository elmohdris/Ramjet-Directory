...
<div class="hotels-view">
    ...
    <?php $this->beginBlock('app\models\Hotels'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            '<span class="glyphicon glyphicon-link"></span> ' . 'Attach' . ' Airport', ['airport-hotels/create', 'AirportHotel'=>['hotels_id'=>$model->id]],
...
<?php $this->endBlock() ?>
    ...
    <?= Tabs::widget(
                 [
                     ...
                     'encodeLabels' => false,
                     'items' => [ [
    'label'   => '<span class="glyphicon glyphicon-asterisk"></span> Hotels',
    'content' => $this->blocks['app\models\Hotels'],
    'active'  => true,
],[
