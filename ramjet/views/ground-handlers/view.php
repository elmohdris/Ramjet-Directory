...
<div class="ground-handlers-view">
    ...
    <?php $this->beginBlock('app\models\GroundHandlers'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            '<span class="glyphicon glyphicon-link"></span> ' . 'Attach' . ' Airport', ['airport-ground-handlers/create', 'AirportGroundHandler'=>['ground_handlers_id'=>$model->id]],
...
<?php $this->endBlock() ?>
    ...
    <?= Tabs::widget(
                 [
                     ...
                     'encodeLabels' => false,
                     'items' => [ [
    'label'   => '<span class="glyphicon glyphicon-asterisk"></span> GroundHandlers',
    'content' => $this->blocks['app\models\GroundHandlers'],
    'active'  => true,
],[
