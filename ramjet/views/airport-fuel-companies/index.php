...
* @var app\models\AirportFuelCompaniesSearch $searchModel
*/

    $this->title = 'Airport Fuel Companies';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="airport-fuel-companies-index">
    ...
    [
        'label' => '<i class="glyphicon glyphicon-arrow-left"> Fuel Companies</i>',
        'url' => [
