...
<div class="fbo-view">
    ...
    <?php $this->beginBlock('app\models\Fbo'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            '<span class="glyphicon glyphicon-link"></span> ' . 'Attach' . ' Airport', ['airport-fbo/create', 'AirportFbo'=>['fbo_id'=>$model->id]],
...
<?php $this->endBlock() ?>
    ...
    <?= Tabs::widget(
                 [
                     ...
                     'encodeLabels' => false,
                     'items' => [ [
    'label'   => '<span class="glyphicon glyphicon-asterisk"></span> Fbo',
    'content' => $this->blocks['app\models\Fbo'],
    'active'  => true,
],[
